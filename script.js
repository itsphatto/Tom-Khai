(function () { 
  ...
  const EGGS = {
    runny: { label: 'Runny Yolk', icon: RUNNY_IMG, time: 360 },
    soft: { label: 'Soft Boil', icon: SOFT_IMG, time: 480 },
    medium: { label: 'Medium Boil', icon: MEDIUM_IMG, time: 600 },
    hard: { label: 'Hard Boil', icon: HARD_IMG, time: 900 }
  };
